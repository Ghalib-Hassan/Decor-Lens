...
class AddCustomizableItem extends StatefulWidget {
  const AddCustomizableItem({super.key});

  @override
  State<AddCustomizableItem> createState() => _AddCustomizableItemState();
}
...
class _AddCustomizableItemState extends State<AddCustomizableItem> {
  ...
  // Function to handle adding the custom item
  void addCustomItem() async {
    ...
    try {
      ...
      await AdminItemService().addCustomItem(
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Add Item Button
                  CustomButton(
                    buttonText: 'Add Customizable Item',
